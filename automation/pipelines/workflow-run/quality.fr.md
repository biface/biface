...
> Pour l'adopter : copier tel quel dans `.github/workflows/` du projet et ajuster la version Python de
> référence si besoin. Suppose un `tox.ini` modelé sur [`shared/tox.ini`](../../../shared/tox.ini).
